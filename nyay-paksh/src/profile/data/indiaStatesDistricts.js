const indiaStatesDistricts = {
  "Andhra Pradesh": [
    ...
    "Vizianagaram","West Godavari","East Godavari","Kadapa","vijayawada"
  ],

  "Arunachal Pradesh": [
    "Tawang","West Kameng","East Kameng","Papum Pare",
    "Lower Subansiri","Upper Subansiri","West Siang",
    "East Siang","Upper Siang","Lower Dibang Valley",
    "Upper Dibang Valley","Anjaw","Changlang","Tirap","Longding"
  ],
  ...
  "Odisha": [
    ...
    "Kandhamal","Kendrapara","Kendujhar","Khordha",
  ...
  "Telangana": [
    ...
    "Ranga Reddy","Sangareddy","Siddipet","Suryapet",
